...
[Supermemory](https://github.com/supermemoryai) - 这周我把它接入了 [Zo](https://zo.computer?referrer=acolombiadev)，解决一个一直困扰我的问题：记忆在新 chat 窗口里就没了。Supermemory 提供语义搜索和知识图谱，上下文真的能持久保存。API 很干净，搭建比预想快，而且开源。我在 GitHub Open Source Friday 上[采访](https://www.youtube.com/watch?v=83DRdPdod7k)了创始人 [Dhravya Shah](https://x.com/DhravyaShah)——一个才华横溢的 20 岁独立创始人，在攻克前沿问题。
